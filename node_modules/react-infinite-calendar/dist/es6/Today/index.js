	...
	babelHelpers.createClass(Today, [{
		...
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: classNames(style.root, (_classNames = {}, babelHelpers.defineProperty(_classNames, style.show, show), babelHelpers.defineProperty(_classNames, style.chevronUp, show == 1), _classNames)), style: { color: theme.floatingNav.color, backgroundColor: theme.floatingNav.background }, onClick: this.scrollToToday, ref: 'node' },
				React.createElement(
					'div',
